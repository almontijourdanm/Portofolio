              ...
              <AnimateOnScroll animation="fade-right" delay={200}>
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    After years in freight forwarding and logistics, I
                    discovered my passion for creating digital solutions. This
                    led me to take a bold step and join Hacktiv8's immersive
                    coding bootcamp from December 2024 to April 2025.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
