...
const timelineEvents: TimelineEvent[] = [
    ...
    title: "Team Leader Fullstack Javascript",
    description: "Nomina Teknograsi Indodata",
    category: "work",
    icon: <Briefcase className="h-6 w-6" />,
    details: [
      "Leading a team of fullstack JavaScript developers",
      "Building dashboard monitoring solutions for collection in multifinance companies",
      "Managing project timelines and deliverables while ensuring code quality",
      "Implementing modern frontend architectures with React and Next.js",
      "Developing robust backend services using Node.js and databases",
      "Collaborating with stakeholders to define project requirements and features"
    ],
  },
  {
    id: "milestone-2",
